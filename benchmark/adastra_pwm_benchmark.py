...
REF_PATH = BASE_PATH + '/greco-assembly/hg38.fa'
PWM_PATH = BASE_PATH + \
...
FASTA_PATH = BASE_PATH + \
    '/greco-fasta/motifs_organized_fasta/{name}@{pwm_name}@a.fasta'
PV_PATH = BASE_PATH + \
    '/greco-fasta/motifs_organized_fasta/' + \
    '{name}@{pwm_name}@a.processed.fasta'
ADASTRA_PATH = BASE_PATH + '/adastra/TF'
RESULT_PATH = '/home/nikonov/benchmark/adastra_motifs_organized_v5/'
...
def write_sequence(row, motif_length, outfile):
    ...
    output = subprocess.check_output(['bedtools', 'getfasta',
...
if __name__ == '__main__':
    filename = RESULT_PATH + sys.argv[1] + '.tsv'
